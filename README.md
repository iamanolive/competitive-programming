...
* Beginner - Reduce but grow (Rated 8 kyu - easiest - on CodeWars)
* Beginner series #2 Clock (Rated 8 kyu - easiest - on CodeWars)
* Binary Addition (Rated 7 kyu on CodeWars)
* Calculate Average (Rated 8 kyu - easiest - on CodeWars)
* Calculate BMI (Rated 8 kyu - easiest - on CodeWars)
* Convert a Boolean to a String (Rated 8 kyu - easiest - on CodeWars)
* Convert number to reversed array of digits (Rated 8 kyu - easiest - on CodeWars)
* DNA to RNA conversion (Rated 8 kyu - easiest - on CodeWars)
* Even or Odd (Rated 8 kyu - easiest - on CodeWars)
* Fake Binary (Rated 8 kyu - easiest - on CodeWars)
* Find Maximum and Minimum values of a list (Rated 8 kyu - easiest - on CodeWars)
* Function 1 - Hello World (Rated 8 kyu - easiest - on CodeWars)
* Remove Exclamation Marks (Rated 8 kyu - easiest - on CodeWars)
* Remove String Spaces (Rated 8 kyu - easiest - on CodeWars)
* Returning Strings (Rated 8 kyu - easiest - on CodeWars)
* Square(n) Sum (Rated 8 kyu - easiest - on CodeWars)
* String Repeat (Rated 8 kyu - easiest - on CodeWars)
* Sum of Positive (Rated 8 kyu - easiest - on CodeWars)
* Sum of two lowest positive integers (Rated 7 kyu on CodeWars)
...
* A needle in the haystack (rated 8 kyu on CodeWars)
* Abbreviate a two word name (rated 8 kyu on CodeWars)
* Beginner Series #2 Clock (rated 8 kyu on CodeWars)
* Beginner Series #4 Cockroach (rated 8 kyu on CodeWars)
* Convert a number to a string (rated 8 kyu on CodeWars)
* Convert a string to a number (rated 8 kyu on CodeWars)
* Convert a string to an array (rated 8 kyu on CodeWars)
* Convert number to reversed array of digits (rated 8 kyu on CodeWars)
* Grasshopper: Grade Book (rated 8 kyu on CodeWars)
* Grasshopper: Personalized Message (rated 8 kyu on CodeWars)
* Grasshopper: Summation (rated 8 kyu on CodeWars)
* Function 1: Hello World (rated 8 kyu on CodeWars)
* If you can't sleep, just count sheep!! (rated 8 kyu on CodeWars)
* Invert Values (rated 8 kyu on CodeWars)
* Is he gonna survive? (rated 8 kyu on CodeWars)
* Beginner: Lost without a map (rated 8 kyu on CodeWars)
* Opposites Attract (rated 8 kyu on CodeWars)
* Beginner: Reduce but Grow (rated 8 kyu on CodeWars)
* Return Negative (rated 8 kyu on CodeWars)
* Reversed Sequence (rated 8 kyu on CodeWars)
* Reversed String (rated 8 kyu on CodeWars)
* Beginner Series #1 School Paperwork (rated 8 kyu on CodeWars)
* Simple Multiplication (rated 8 kyu on CodeWars)
* Sum Arrays (rated 8 kyu on CodeWars)
* Sum without highest and lowest number (rated 8 kyu on CodeWars)
* The feast of many beasts (rated 8 kyu on CodeWars)
* Thinkful logic drills: Traffic Light (rated 8 kyu on CodeWars)
* What is between? (rated 8 kyu on CodeWars)
* Beginner: You only need one (rated 8 kyu on CodeWars)

### 9th January

* Print Error (rated 7 kyu on CodeWars)
* Binary Addition (rated 7 kyu on CodeWars)
* Complementary DNA (rated 7 kyu on CodeWars)
* Descending Order (rated 7 kyu on CodeWars)
* Find the stray number (rated 7 kyu on CodeWars)
* Highest and lowest (rated 7 kyu on CodeWars)
* Is this a triangle? (rated 7 kyu on CodeWars)
* Isograms (rated 7 kyu on CodeWars)
* Remove the minimum (rated 7 kyu on CodeWars)
* Reverse Words (rated 7 kyu on CodeWars)
* Shortest Word (rated 7 kyu on CodeWars)
* Sum of numbers (rated 7 kyu on CodeWars)
* Sum of odd numbers (rated 7 kyu on CodeWars)
* Sum of the first Nth term of the series (rated 7 kyu on CodeWars)
* Two to one (rated 7 kyu on CodeWars)
* Who likes it? (rated 6 kyu on CodeWars)
* Two sum (rated 6 kyu on CodeWars)
* Persistent Bugger (rated 6 kyu on CodeWars)
* Are they the same (rated 6 kyu on CodeWars)
* Build Tower (rated 6 kyu on CodeWars)
* Consecutive Strings (rated 6 kyu on CodeWars)
* Delete occurrences of an element if it occurs more than N times (rated 6 kyu on CodeWars)
